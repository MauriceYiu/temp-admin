...
var Login = {
    ...
    initNode: function () {
        ...
        localStorage.setItem("sdktoken",token);
        //

        // crm跳转登录
        var roleFromCrm = getQueryString("roleFromCrm");
        var tokenFromCrm = getQueryString("tokenFromCrm");
        var userTokenFromCrm = getQueryString("userTokenFromCrm");
        if(roleFromCrm){
            localStorage.setItem("role",roleFromCrm);
        }
        if(tokenFromCrm){
            localStorage.setItem("token",tokenFromCrm);
        }
        if(userTokenFromCrm){
            localStorage.setItem("User-Token",userTokenFromCrm);
        }
        // 
