    ...
    $.contextMenu({
        ...
        callback: function(key, options) {
            if (key === 'delete') {
                ...
                if (!this.cache.isCurSessionTeamManager &&
                    msg.flow !== 'out' &&
                    msg.scene === 'team'
                ) {
...
YX.fn.sendDragFileMessage = function(name, dataURL) {
    this.mysdk.sendBlobFile(this.crtSessionType, this.crtSessionAccount, name, dataURL, this.sendMsgDone.bind(this));
};
...
YX.fn.sendMyMessage = function(scene, to, content, callback) {
...
YX.fn.sendMyTipMessage = function(scene, to, content, callback) {
