  ...
  <div class="collegeAdDetail">
    ...
    <div class="content">
      ...
      <el-form class="form-container" ref="postForm" label-width="154px">
        <el-form-item label="学院广告类型">
          <el-select
            class="filter-item"
            style="width: 600px"
            v-model="formParams.adType"
            placeholder="请选择学院广告类型"
            @change="typeChange"
          >
            <el-option
  ...
  export default {
    ...
    data() {
      return {
        ...
        formParams: {
          adId: 0,
//广告类型：index首页轮播广告，service服务市场广告，tool辅助工具广告，guide智能向导广告，collegeCourse学院课程广告，collegeNews学院资讯广告，collegeTech学院技术广告，appGuide引导图，staffGuide员工端引导图
      ...
      tagSubmitForm() {
        ...
        adEdit(this.formParams).then(json => {
          ...
          if (json.status === 200) {
            ...
            this.formParams = {
              adId: 0,
              adType: "collegeCourse",  //index首页轮播广告，service服务市场广告，tool辅助工具广告，course学院广告
              enable: true,
              picture: "",
              queue: null,
              redirectType: "url",
