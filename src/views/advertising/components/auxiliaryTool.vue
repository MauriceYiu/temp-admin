<template>
  <div class="auxiliaryTool">
    ...
    <div class="content">
      <div class="left">
        <div class="main">
          <div class="imgWrap rightImg" :class="{borderStyle:currentIndx===4 }" @click="change(4, formParams4)">
            <img v-if="formParams4.picture" :src="formParams4.picture" class="avatar">
          </div>
          <div class="leftImg">
            <div class="line">
              <div class="img4 imgWrap" :class="{borderStyle:currentIndx===3 }" @click="change(3, formParams3)">
                <img v-if="formParams3.picture" :src="formParams3.picture" class="avatar">
              </div>
              <div class="img3 imgWrap" :class="{borderStyle:currentIndx===2 }" @click="change(2, formParams2)">
    ...
    data() {
      return {
        ...
        formParams: {
          adId: 0,
          click: null,
          adType: "tool",  //index首页轮播广告，service服务市场广告，tool辅助工具广告，course学院广告
          enable: true,
          picture: "",
          queue: 4,
          redirectType: "url",
              ...
              switch (+item.queue) {
                case 4:
                  this.formParams4 = {
                    ...
                    redirectType: item.redirectType.value,
                    queue: item.queue,
                    title: item.title,
                    url: item.url,
                    token: getToken(),
