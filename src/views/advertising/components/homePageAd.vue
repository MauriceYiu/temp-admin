  ...
  <div class="homePageAd">
    ...
    <el-table
      ...
      >
        <template slot-scope="scope">
          <div class="action">
            <div class="status" v-if="hasPerm('ad:banner:index:enable')">
            ...
            <el-button type="text" size="mini" @click="delTag(scope.row)" style="color: #DADADA" v-if="hasPerm('ad:banner:index:delete')">删除</el-button>
            <el-button type="text" size="mini" @click="addTag(scope.row.id)" style="color: #F65860" v-if="hasPerm('ad:banner:index:edit')">编辑</el-button>
