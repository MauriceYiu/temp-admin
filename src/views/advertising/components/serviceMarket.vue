<template>
  <div class="serviceMarket">
    ...
    <div class="content">
      <div class="left">
        <div class="main">
          <div class="imgWrap leftImg" :class="{borderStyle:currentIndx===5 }" @click="change(5, formParams5)">
          ...
          <div class="rightImg">
            ...
            <div class="line">
              <div class="img2 imgWrap" :class="{borderStyle:currentIndx===2 }" @click="change(2, formParams2)">
...
<script>
  ...
  export default {
    ...
    methods: {
      typeChange() {
        console.log(this.formParams.redirectType, "777777777");
      ...
      getList(index) {
        ...
        adList(this.listQuery).then(json => {
          ...
          if (json.status === 200) {
            ...
            if(!index) {
              this.currentIndx = 5;
              this.change(5, this.formParams5)
            }
          }
        })
      },
