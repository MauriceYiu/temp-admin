<template>
  <div class="training">
    <div class="head">
      ...
      <div class="save" @click="addTag(0)"  v-if="hasPerm('business:newcomer:add')">添加</div>
    </div>
    <div class="content">
      <div class="client">
        <div class="filter-container">
          ...
          <div class="right" v-if="hasPerm('business:newcomer:search')">
        ...
        <el-table
          ...
          >
            <template slot-scope="scope">
              <div class="action">
                <div class="status" v-if="hasPerm('business:newcomer:top')">
                <span v-if="scope.row.top">推荐</span>
                ...
                <div class="status" v-if="hasPerm('business:newcomer:enable')">
                ...
                <el-button type="text" size="mini" @click="delTag(scope.row)" style="color: #DADADA" v-if="hasPerm('business:newcomer:delete')">删除</el-button>
                <el-button type="text" size="mini" @click="addTag(scope.row.id)" style="color: #F65860" v-if="hasPerm('business:newcomer:edit')">编辑</el-button>
...
<style>
  ...
  .training .timeLimit .el-form-item__content {
    margin-left: 30px !important;
  }

  .training .el-textarea {
    width: 86%;
  }

  .training .time .el-form-item__content {
    margin-left: 16px !important;
  }
  .el-table::before{
    background: none;
  }
  .training .filter-container .filter-item {
    margin-bottom: 0;
  }
