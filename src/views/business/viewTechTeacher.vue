      ...
      types() {
        departmentAll().then(json => {
          if (json.status === 200) {
           ...
           //
           // let  department = json.data.find((department)=>{
           //
           //    return department.id === this.$route.params.id
           //  })
