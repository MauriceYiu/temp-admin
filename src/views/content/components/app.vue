  ...
  <div class="offlineCourse">
    <div class="filter-container">
      ...
      <div class="right">
        ...
        <el-button v-waves class="filter-item" type="primary" icon="el-icon-search" @click="search" v-if="hasPerm('content:push:app:search')">
          搜索
        </el-button>
    ...
    <el-table
      ...
      >
        <template slot-scope="scope">
          <div class="action">
            <el-button type="text" size="mini" @click="delTag(scope.row)" style="color: #DADADA" v-if="scope.row.executeTime ===0  && hasPerm('content:push:app:delete')">删除</el-button>
            <el-button type="text" size="mini" @click="addTag(scope.row.id)" style="color: #F65860" v-if="scope.row.executeTime  === 0 &&  hasPerm('content:push:app:edit')">编辑</el-button>
            <el-button type="text" size="mini" @click="viewTag(scope.row.id)" style="color: #F65860" v-if="scope.row.executeTime  > 0 &&  hasPerm('content:push:app:detail')" >查看</el-button>
