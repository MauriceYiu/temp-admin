  ...
  <div class="techChild">
    ...
    <el-table
      ...
      <el-table-column align="center" label="标签">
        <template slot-scope="scope">
          <span v-if="scope.row.tags">{{scope.row.tags.join("、")}}</span>
        </template>
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          <div class="action">
            <div class="status" v-if="hasPerm('content:tech:enable')">
...
<style>
  ...
  .techChild .filter-container .left .el-tabs__nav {
    margin-left: 0;
  }
</style>
