      ...
      <div class="left">
        <el-form class="form-container" ref="postForm" label-width="100px">
          ...
          <el-form-item label="分类" prop="title">
            <el-select style="width: 618px" v-model="formParams.typeIds" filterable multiple placeholder="请选择课程分类">
              <el-option
          ...
          <el-form-item label="作者">
            ...
            <el-select
              ...
              style="width: 260px"
              filterable
              v-model="formParams.createUserId"
              placeholder="请选择作者"
            >
              <el-option
  ...
  export default {
    ...
    methods: {
      ...
      initData() {
        courseDetail({
          ...
          if (json.status === 200) {
            ...
            this.formParams.createUserId = json.data.createUserId;
            ...
            this.formParams.saleBase = json.data.saleBase
      ...
      tagSubmitForm() {
        ...
        if (!this.formParams.createUserId) {
          this.$message({
            message: "请选择作者",
            type: "error"
          });
...
<style>
  ...
  .techDetail .timeLimit .el-form-item__content {
    margin-left: 30px !important;
  }

  .techDetail .el-textarea {
    width: 86%;
  }

  .techDetail .time .el-form-item__content {
