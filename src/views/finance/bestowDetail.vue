<template>
  <div class="bestowDetail">
    ...
    <div class="content">
      ...
      <div class="data">
        <div class="left">
          <div class="item">打赏<span>{{ data.base | showDecimal }}元</span></div>
          <div class="item">已提现<span>{{ data.base * data.fine /100 | showDecimal}}元</span></div>
        </div>
        <div class="right">
...
<style>
  ...
  .bestowDetail .timeLimit .el-form-item__content {
    margin-left: 30px !important;
  }

  .bestowDetail .el-textarea {
    width: 86%;
  }

  .bestowDetail .time .el-form-item__content {
