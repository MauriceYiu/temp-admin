  ...
  <div class="OfflineCourse">
    ...
    <el-table
      ...
      <el-table-column align="center" label="名称">
        <template slot-scope="scope">
          <span>{{scope.row.activity.title}}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" label="抵扣">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" label="备注">
        <template slot-scope="scope">
          <span>{{scope.row.inputRemark}}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" label="时间">
        <template slot-scope="scope">
          <span>{{scope.row.activity.createTime | parseTime('{y}-{m}-{d} {h}:{i}')}}</span>
        </template>
      </el-table-column>
