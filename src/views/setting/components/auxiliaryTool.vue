      ...
      <div class="client">
        ...
        <el-table
          ...
          >
            <template slot-scope="scope">
              <div class="action">
                <div class="status" v-if="hasPerm('settings:quickEntry:tool:top')">
                ...
                <div class="status" v-if="hasPerm('settings:quickEntry:tool:enable')">
                ...
                <el-button type="text" size="mini" @click="delTag(scope.row)" style="color: #DADADA" v-if="hasPerm('settings:quickEntry:tool:delete')">删除</el-button>
                <el-button type="text" size="mini" @click="addTag(scope.row.id)" style="color: #F65860" v-if="hasPerm('settings:quickEntry:tool:edit')">编辑</el-button>
...
<style>
  ...
  .auxiliaryTool .timeLimit .el-form-item__content {
    margin-left: 30px !important;
  }

  .auxiliaryTool .el-textarea {
    width: 86%;
  }

  .auxiliaryTool .time .el-form-item__content {
