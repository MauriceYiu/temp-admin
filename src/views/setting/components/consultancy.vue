      ...
      <div class="client">
        ...
        <el-table
          ...
          <el-table-column align="center" label="时间">
            <template slot-scope="scope">
              <span>{{data.createTime | parseTime('{y}-{m}-{d} {h}:{i}')}}</span>
            </template>
          </el-table-column>
          <el-table-column align="center" label="状态">
          <template slot-scope="scope">
          <span>{{data.enable ? '已处理':'未处理'}}</span>
          </template>
          </el-table-column>
          ...
          >
            <template slot-scope="scope">
              <div class="action">
                <div class="status">
                <span v-if="data.enable">已处理</span>
                <span v-if="!data.enable">未处理</span>
                <el-switch
                ...
                <el-button type="text" size="mini" @click="delTag(data)" style="color: #DADADA">删除</el-button>
                <el-button type="text" size="mini" @click="addTag(data.id)" style="color: #F65860">查看</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        newsType(this.listQuery).then(json => {
