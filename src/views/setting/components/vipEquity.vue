    ...
    <div class="content">
      <div class="client">
        ...
        <el-table
          ...
          <el-table-column align="center" label="权益说明">
            <template slot-scope="scope">
              <img style="width:60px" :src="scope.row.introUrl" alt="">
              <!--<span>{{scope.row.introUrl}}</span>-->
            </template>
          </el-table-column>
          ...
          <el-table-column align="center" label="高于此级别的免费">
            <template slot-scope="scope">
              <span>{{scope.row.freeForGreater?"是":"否"}}</span>
            </template>
          </el-table-column>
          <el-table-column align="center" label="允许直播发弹幕">
            <template slot-scope="scope">
              <span>{{scope.row.barrage?"是":"否"}}</span>
            </template>
          </el-table-column>
            ...
            <template slot-scope="scope">
              <div class="action">
                <!--<div class="status">-->
                  ...
                  <!--</el-switch>-->
                <!--</div>-->
                <el-button type="text" size="mini" @click="delTag(scope.row)" style="color: #DADADA" v-if="hasPerm('settings:members:list:delete') ">删除</el-button>
                <el-button type="text" size="mini" @click="addTag(scope.row.id)" style="color: #F65860" v-if="hasPerm('settings:members:list:edit') ">编辑</el-button>
...
<style>
  ...
  .vipEquity .timeLimit .el-form-item__content {
    margin-left: 30px !important;
  }

  .vipEquity .el-textarea {
    width: 86%;
  }

  .vipEquity .time .el-form-item__content {
