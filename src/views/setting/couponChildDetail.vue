  ...
  <div class="couponChildDetail">
    ...
    <div class="content">
      <el-form class="form-container" ref="postForm" label-width="154px">
        ...
        <el-form-item label="签到天数" v-if="formParams.type==='checkIn'">
          <el-input
            style="width:600px;"
            v-model="formParams.checkInDays"
            placeholder="输入签到天数"
          />
        </el-form-item>
        ...
        <el-form-item label="时间设置">
          <div class="expireTime" v-if="radio=='2'||radio=='3'" style="margin-bottom: 10px">
  ...
  export default {
    ...
    methods: {
      ...
      initData() {
        couponDetail({
          ...
          if (json.status === 200) {
            ...
            if(json.data.days && json.data.validStartTime){
              this.radio = 3
            }
            if(!json.data.days && json.data.validStartTime){
              this.radio = 2
            ...
            this.formParams.checkInDays = json.data.checkInDays ? json.data.checkInDays:null;
      ...
      tagSubmitForm() {
        ...
        if (this.formParams.type === 'checkIn' && !this.formParams.checkInDays) {
          this.$message({
            message: "请输入签到天数",
            type: "error"
          });
