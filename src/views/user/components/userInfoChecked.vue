<template>
  <div class="userInfo">
    <el-form class="form-container" ref="postForm" label-width="100px">
      <el-form-item prop="title" label="售后处理" class="bold"></el-form-item>
      <div class="flex">
        <el-form-item class="leftFormItem" prop="title" label="处理人">
          <span v-if="order.afterSale">{{order.afterSale.handleStaffName}}</span>
        </el-form-item>

        <el-form-item class="rightFormItem" prop="title" label="处理类型">
          <span>{{ order.afterSale.handleType  }}</span>
        </el-form-item>
      </div>
      <div class="flex">
        <el-form-item class="leftFormItem" prop="title" label="处理时间">
          <span>{{ order.afterSale.handleTime | parseTime('{y}-{m}-{d} {h}:{i}')}}</span>
        </el-form-item>

        <el-form-item class="rightFormItem" prop="title" label="退币">
          <span style="color: red">{{ order.afterSale.refund | showDecimal  }}币</span>
        </el-form-item>
      </div>
      <el-form-item prop="title" label="处理说明"></el-form-item>
      <el-form-item prop="title" class="tip" style="margin-left: 0">
        <span>{{ order.afterSale.remark  }}</span>
      </el-form-item>

      <el-form-item prop="title" label="提交信息" class="bold marginTop"></el-form-item>
      ...
      <div class="flex">
        ...
        <el-form-item class="rightFormItem" prop="title" label="提交类型">
          <span>{{ order.afterSale.type  }}</span>
        </el-form-item>
      </div>
      ...
      <div class="flex">
        ...
        <el-form-item class="rightFormItem" prop="title" label="付费">
          <span>{{ order.price | showDecimal  }}币</span>
        </el-form-item>
      </div>
